...
static void bar_set_value(lv_obj_t *bar, int16_t value) { lv_bar_set_value(bar, value, LV_ANIM_OFF); }

static void lvgl_test_2(void)
{ /*Texts of the list elements*/
    lv_test_theme_2();
}
MSH_CMD_EXPORT(lvgl_test_2, test lvgl 2)
